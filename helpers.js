 ...
 * @param {Array} arr any array
 //the @ param specifies that the function createFrequencyCounter() 
 takes a single parameter, arr,which is an array.
*/
...
//example of median:
// findMedian([1,3,3,6,7,8,9]) = 6
// findMedian([1,2,3,4,5,6,8,9]) = 4.5 (= (4+5) / 2 )
